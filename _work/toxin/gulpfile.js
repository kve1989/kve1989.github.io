...
const localhost = "localhost:3000",
	fileswatch = "html,htm,php,txt,yaml,twig,json,md,pug",
...
const watchFiles = () => {
	...
	gulp.watch(src + "/**/*.pug", { usePolling: true }, html);
	gulp.watch(
...
const build = gulp.series(clean, gulp.parallel(html, styles, scripts, images, copy));
